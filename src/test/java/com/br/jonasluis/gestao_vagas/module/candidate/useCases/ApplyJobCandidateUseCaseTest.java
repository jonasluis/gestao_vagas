package com.br.jonasluis.gestao_vagas.module.candidate.useCases;
...
public class ApplyJobCandidateUseCaseTest {
    ...
    @Test
    @DisplayName("Should not be able to apply for job when candidate not found job")
    public void  should_not_be_able_to_apply_for_Job_when_candidato_not_found_job(){
